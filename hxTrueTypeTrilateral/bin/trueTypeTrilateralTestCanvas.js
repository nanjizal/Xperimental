...
MainCanvas.__name__ = true;
MainCanvas.main = function() {
	new MainCanvas();
};
MainCanvas.rotateXYZ = function(refTriangles,targetTriangles,rX,rY,rZ,ox,oy,oz,zSpecial) {
	var sX = Math.sin(rX);
	var sY = Math.sin(rY);
	var sZ = Math.sin(rZ);
	var cX = Math.cos(rX);
...
MainCanvas.prototype = {
	...
	,render: function(i) {
		...
		MainCanvas.rotateXYZ(this.trianglesIn,this.triangles,0,this.theta,0,512.,384.,-1,-1);
		this.drawTriangles();
	}
...
//# sourceMappingURL=trueTypeTrilateralTestCanvas.js.map