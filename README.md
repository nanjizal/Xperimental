...
But performance was terrible, swapping images ( flush ) was very heavy and also the change between the gradient/color and image shaders. So I ported RectPack2D a **c** and **js** library used for efficient rectangle packing.
...
The tools need to be improved to allow the placement JSON to be created by dragging around limbs and rotation cross hairs, the project may extend.
