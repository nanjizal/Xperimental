...
Main.prototype = {
	...
	,render: function(i) {
		...
		path.width = 0.3;
		path.moveTo(this.jointsF[0].x,this.jointsF[0].y);
		var _g24 = 1;
		var _g112 = this.points;
		while(_g24 < _g112) {
			var i11 = _g24++;
			var x_ = this.jointsF[i11].x;
			var y_ = this.jointsF[i11].y;
		...
		var colorID1 = this.appColors.indexOf(4473924);
		var tri27;
		var _g35 = 0;
		...
		path1.width = 0.3;
		path1.moveTo(this.joints[0].x,this.joints[0].y);
		var _g210 = 1;
		var _g36 = this.points;
		while(_g210 < _g36) {
			var i17 = _g210++;
			var x_1 = this.joints[i17].x;
			var y_1 = this.joints[i17].y;
		...
		var colorID2 = this.appColors.indexOf(3355443);
		var tri42;
		var _g44 = 0;
		...
		var _g45 = 0;
		var _g121 = triangles.length;
		while(_g45 < _g121) {
			var i23 = _g45++;
			tri43 = triangles[i23];
			if(tri43.mark != 0) {
				g.beginFill(triangleColors[tri43.mark]);
			} else {
				g.beginFill(triangleColors[tri43.colorID]);
				g.lineStyle(0.,triangleColors[tri43.colorID],1.);
			}
			g.drawTri([ox + tri43.ax * s,oy + tri43.ay * s,ox + tri43.bx * s,oy + tri43.by * s,ox + tri43.cx * s,oy + tri43.cy * s]);
			g.endFill();
		}
	}
	,plotPoint: function() {
