...
class Main {
    ...
    public function new(){
        ...
        mousePos = new Apoint4( { x: 100., y:100., z:0., w: 1. } );
        setupExperiments();
    ...
    inline
    function chain(){
        var jointRender = ( i: Int, joint: Apoint4 ) 
    ...
    inline
    function linkSpots( index: Int, spots: Array<Apoint4>, width: Float, color: AppColors ){
